    ...
    <div class="row">
       ...
       <div class="col-md-4">
           <div class="well">
               ...
               Esta aplicación utiliza el clasificador Naive Bayes para realizar la predicción de victorias entre jugadores
           ...
           <div class="well">
               ...
               se desean evaluar, indicar la superficie donde jugarán y presionar el botón "Predecir" para obtener el
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <form action="index.jsp" method="POST">
                            ...
                            <center><input class="btn btn-primary" type="submit" value="Predecir" /></center>
                         </form> 
                    </div>
        ...
        if(!jugador1.isEmpty() && !jugador2.isEmpty()){
            if(!jugador1.equals(jugador2)){
                ...
                if(!result.equals("SIN INFORMACION")){
                    ...
                    String resultado = "" +
                            "<span class=\"label label-success\">RESULTADOS:    ( "+ superficieJuego+" )</span><br/><br/>" +
                            "<div class=\"row\">" +
                                "<div class=\"col-md-6\">" +
